...
class EditTweet(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, template_name='tweets/update-tweet.html', context={'tweet_msg': tweet_msg, 'tweet_id': tweet_id})
...
class UserTimeline(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        tweets = Tweet.objects.filter(user=profile_id).order_by('-date_created')
